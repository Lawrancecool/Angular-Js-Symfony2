...
class RegistrationController extends Controller
{
    public function registerAction(Request $request)
    {
        ...
        $dispatcher->dispatch(UserEvents::REGISTRATION_INITIALIZE, $event);
        ...
        return $this->render('DemoBundle:Registration:register.html.twig', array(
    ...
    public function checkEmailAction()
    {
        ...
        return $this->render('DemoBundle:Registration:checkEmail.html.twig', array(
            'user' => $user,
        ));
    }
    ...
    public function confirmAction(Request $request, $token)
    {
        ...
        $event = new GetResponseUserEvent($user, $request);
        $dispatcher->dispatch(UserEvents::REGISTRATION_CONFIRM, $event);
    ...
    public function confirmedAction()
    {
        ...
        return $this->render('DemoBundle:Registration:confirmed.html.twig', array(
            'user' => $user,
