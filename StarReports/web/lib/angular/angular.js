    ...
    Scope.prototype = {
      ...
      $watchCollection: function(obj, listener) {
        ...
        function $watchCollectionAction() {
            // Raja: Patched Because of https://github.com/revolunet/angular.js/commit/4c8c8b5fa454f31f95cf01024e48b3e13d273f77
            if (initRun) {
                initRun = false;
    ...
    if (isValid) {
      if (queue) {
        ...
        if (!queue.length) {
          ...
          if (!element.attr('ngNoPropagate') || element.attr('ngNoPropagate') == 'false') { 
